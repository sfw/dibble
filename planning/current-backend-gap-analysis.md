...
- The learner summary endpoint now packages recent calibration, durable progress-trend, and activity context into a frontend-ready overview instead of requiring direct audit-log reads.
...
- broader cross-session use of the new run-summary calibration signals beyond the current router, learner-state, prompt, generation-mode, and learner-summary hooks
