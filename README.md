...
4. Deepen the learner-strategy layer beyond the current heuristic recovery, plateau, relapse, volatility, and per-KC misconception disambiguation signals so it can drive stronger per-KC sequencing and within-session adaptation.
