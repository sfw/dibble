...
4. Extend the new session-aware calibration beyond single linked events into richer multi-step outcome traces that aggregate chains of generated content, observations, and assessments across a learning run.
