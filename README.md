...
4. Deepen the new learner-strategy profile beyond the current heuristic recovery, plateau, relapse, and volatility signals so it can model richer misconception recurrence and stronger per-KC sequencing decisions.
