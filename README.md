...
- Prompt template selection is now versioned and variant-aware, with deterministic experiment bucketing and prompt metadata persisted on generated responses
...
4. Deepen conversational assessment with stronger evidence scoring, outcome-linked calibration, and richer turn-policy experimentation.
