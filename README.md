...
4. Deepen the learner-strategy layer beyond the current heuristic recovery, plateau, relapse, volatility, per-KC misconception disambiguation, and first-pass KC sequencing so it can drive richer within-session adaptation.
