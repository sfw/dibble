...
4. Extend the new persisted run-summary calibration layer into longer-horizon cross-session adaptation and summary compaction so the system can move from recent durable summaries toward broader learner-history signals.
