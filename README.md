...
3. Deepen the new durable learner-state profile beyond the current cross-session affective/load/metacognitive calibration so routing and content-mode selection rely less on hand-tuned heuristics.
