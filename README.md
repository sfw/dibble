...
4. Calibrate the now-broader adaptive prompt-selection loop against longer-horizon learner outcomes instead of only immediate generation and assessment signals.
