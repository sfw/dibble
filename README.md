...
3. Deepen curriculum-grounding fidelity beyond the current excerpt packaging while keeping the retrieval path testable and inspectable.
4. Extend retrieval packaging and excerpt selection without turning the backend into a sprawling RAG platform.
5. Keep extending predictive follow-up quality once the stronger grounding signals are in place.
