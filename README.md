...
4. Tighten the new downstream-outcome calibration window so adaptive prompt selection can learn from richer session/context signals instead of only nearby observations.
