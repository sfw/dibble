...
4. Replace more of the within-session controller's current heuristic support-budget and loop-risk logic with stronger outcome-backed policies once real session traces accumulate.
