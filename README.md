...
4. Extend the new cross-generation session-outcome tracing beyond audit-time heuristics into more explicit run summaries and longer-horizon learner-outcome calibration.
