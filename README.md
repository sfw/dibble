...
4. Extend the new session-aware calibration beyond single-generation matching into richer multi-step outcome traces that include sequences of generated content and assessments.
