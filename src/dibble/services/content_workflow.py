    ...
    def generate_content(self, request: GenerationRequest) -> GeneratedContent:
        ...
        self.audit_store.append(
            ...
            payload={
                ...
                "verification_attempts": metadata.verification_attempts,
                ...
                "moderation_llm_verdict": metadata.moderation.llm_verdict,
                "moderation_llm_categories": metadata.moderation.llm_categories,
                "moderation_llm_reason": metadata.moderation.llm_reason,
