    ...
    def __post_init__(self) -> None:
        if self.request_term_categories is None:
            self.request_term_categories = {
                ...
                "give the answer": ("academic_integrity", "Request asked for answer-only help instead of instruction."),
                "address": ("privacy_risk", "Request asked for personal location or contact details."),
        ...
        if self.response_term_categories is None:
            self.response_term_categories = {
                ...
                "give the answer": ("academic_integrity", "Generated content drifted into answer-only help."),
                "address": ("privacy_risk", "Generated content included personal address or location details."),
